...
describe('AccountPage', () => {
  ...
  describe('ionViewWillEnter', () => {
    it('isLogged', async () => {
      userService.getUser = jasmine.createSpy().and.returnValue(new User());
    ...
    it('isNotLogged', async () => {
      ...
      authService.isAuthenticated = jasmine.createSpy().and.returnValue(false);
      component.ionViewWillEnter();
  ...
  it('logout', async () => {
    ...
    authService.logout = jasmine.createSpy().and.returnValue(Promise.resolve());
