...
describe('CarsListPage', () => {
    ...
    describe('getCars', () => {
        ...
        it('getCars', () => {
            const response = { items: [], paginator: { currentPage: 0, pageSize: 20, totalPages: 0, total: 20 } }
        ...
        it('getCarsOnSuccess with event', () => {
            component.vm.cars = [];
            component.getCarsOnSuccess({ items: [new Car(), new Car()] }, { target: { complete: () => { } } })
    ...
    describe('getBrands', () => {
        it('getBrands', () => {
            const response = { items: [], paginator: { currentPage: 0, pageSize: 20, totalPages: 0, total: 20 } }
            spyOn(brandService, 'getAllBrandsAndCars').and.returnValue(of(response));
        ...
        it('getBrandsOnSuccess with event', () => {
            component.vm.brands = [];
            component.getBrandsOnSuccess({ items: [new Brand(), new Brand()] }, { target: { complete: () => { } } })
